...
def longestPalindrome4(s):
    ...
    for L in range(n):
        for i in range(n):
            ...
            if dp_table[i][j] and L + 1 > len(ans):
                ans = s[i:j+1]
            # print(dp_table)
            # print(ans)
    return ans
...
def longestPalindrome5(s):
    ...
    for idx in range(len(s)):
        ...
        if r1 - l1 > r2 - l2 and r1-l1 > len(res):
            res = s[l1:r1+1]
        if r1 - l1 < r2 - l2 and r2-l2 > len(res):
            res = s[l2:r2+1]
    return res

print(longestPalindrome5("babad"))
print(longestPalindrome5("bd"))
